            ...
            <div class="col s12 m12 l12">
                <div class="card">
                    <div class="card-content">
                        <div>
                            <h5>Add Ofer Information</h5>
                            <section>
                                <div class="wizard-content">
                                    <div class="row">
                                        <div class="col m12">
                                            <div class="row">
                                                <form action="insertofer.php" enctype="multipart/form-data" method="post">
                                                    <?php
                                                    include ('connection.php');
                                                    ...
                                                    <div class="input-field col s6">
                                                        <label >price</label>
                                                        <input  name="price" type="text" class="required validate" required>
                                                    </div>
                                                    <div class="input-field col s6">
                                                        <label >State</label>
                                                        <input  name="State" type="text" class="required validate" required>
                                                    </div>
                                                    <div class="input-field col s6">
                                                        <label >Quantity</label>
                                                        <input  name="Quantity" type="text" class="required validate" required>
                                                    </div>
                                                    <div class="input-field col s6">
                                                        <label >Product-Id-Type</label>
                                                        <input  name="pid" type="text" class="required validate" required>

                                                    </div>
                                                    <div class="input-field col s6">
                                                        <label >Discount Price</label>
                                                        <input  name="disprice" type="text" class="required validate" required>
                                                    </div>
                                                    <div class="input-field col s6">
                                                        <label >Discount Start Date</label>
                                                        <input  name="sdate" type="text" class="required validate" required>
                                                    </div>
                                                    <div class="input-field col s6">
                                                        <label >Discount end Date</label>
                                                        <input  name="edate" type="text" class="required validate" required>
                                                    </div>
...
//                                                $target_file = $target_dir . basename($_FILES["pic4"]["name"]);
                                            ...
                                            $sql = mysqli_query($con,"INSERT INTO `offer`( `category`, `sku`, `price`, `quanity`, `state`, `productidtype`, `disprice`, `disstartdate`, `disenddate`) VALUES ('$category','$sku','$price','$State','$Quantity','$pid','$disprice','$sdate','$edate')");

                                            if($sql)
                                            {
                                                echo "<script type=\"text/javascript\">
                                                            alert(\"Data Added Successfully\");
                                                            window.location=\"insertofer.php\";
                                                            </script>";
                                            }
                                        }
                                        ?>
